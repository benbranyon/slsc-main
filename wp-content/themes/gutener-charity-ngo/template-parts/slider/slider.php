...
$width_control = '';
if( get_theme_mod( 'slider_width_controls', 'boxed' ) == 'boxed' && get_theme_mod( 'display_slider_on', 'blog-page-below-header' ) == 'blog-page-above-latest-posts' ){
	$width_control = 'boxed';
}elseif( get_theme_mod( 'slider_width_controls', 'boxed' ) == 'boxed' ){
